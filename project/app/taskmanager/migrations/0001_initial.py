# Generated by Django 3.2.9 on 2021-12-23 12:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tasckPeriodical', models.DurationField(max_length=100, null=True, verbose_name='Период, через который нужно напоминать')),
            ],
        ),
    ]
