...
class Tasck(models.Model):
    tasckTitle = models.CharField("Название задачи", max_length=100, error_messages={
    ...
    tasckStartOfTheEventDate = models.DateField("Дата начала мероприятия", error_messages={
        "invalid": "Ваша задача накладывается на другую задачу"
    })
